...
def format_phone(phone):
    ...
    ext_str = f" доб.{ext_match.group(1)}" if ext_match else ""
    main_part = phone[:ext_match.start()] if ext_match else phone
